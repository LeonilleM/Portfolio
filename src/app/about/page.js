...
export default async function About() {
    return (
        <div className="bg-F5F0E7 min-h-screen">
            <NavBar />
            <div className="pt-20 pb-52 container mx-auto lg:px-40 text-303837">
                <div className="py-2 space-y-6 items-center">
                    <h1 className="text-5xl text-4E4E4E font-roboto sm:text-start text-center font-bold">Hello, I'm Leonille!</h1>
                    <div className="flex sm:flex-row flex-col sm:space-x-5 mx-4 space-y-3 text-303837">
